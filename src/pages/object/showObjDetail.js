...
import { Form, Button, Input, Select, Row, Col, Tabs, Card, Table, Breadcrumb } from 'antd';
...
const ShowObjDeail = (props) => {
  ...
  useEffect(() => {
    Axios.get('/api/objectList/'+props.match.params.id)
    .then((res) =>{
      if(res.status === 200){
...
export default Form.create()(ShowObjDeail);