...
import { Modal, Form, Button, Input, Select, Row, Col, Tabs, Card, Table } from 'antd';
              ...
              <Col span={12}>
                <Form.Item label="制造商">
                  {getFieldDecorator("manufacturers", {
                    initialValue: obj.manufacturers,
                  })(
              ...
              <Col span={12}>
                <Form.Item label="属性名称">
                  {getFieldDecorator("attributeName", {
                    initialValue: obj.attributeName,
                  })(
