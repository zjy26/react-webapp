...
import { brands, ROBOT_OBJECT_TYPE, ROBOT_OBJECT_STATUS, VIDEO_STREAM } from '../../api'
import store from '../../store'
import { locationTreeAction, brandsAction, robotObjectTypeAction, robotObjectStatusAction, videoStreamAction } from '../../store/actionCreators1'
...
const Index = (props) => {
  ...
  useEffect(() => {
    props.dispatch(locationTreeAction())
  }, [])
...
export default connect(mapStateToProps)(React.memo(Form.create()(Index)))